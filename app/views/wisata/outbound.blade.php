	...
	<div class="container fix-content">
		<div class="row">
			...
			<div class="col-md-6">
				<p align="justify">
					...
					Beberapa wahana Outbound yang disuguhkan di Rest Area antara lain flying fox, high rope, Atv, wisata berkuda dan lain-lain.
				</p>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-offset-1 col-md-6">
				<p align="justify">
					Ada beberapa outbound yang disuguhkan memiliki keunikan tersendiri. Misalnya saja flying fox, wahana ini memiliki panjang 137 meter. 
					...
					Dijamin tidak akan menyesal dan pasti akan ketagihan untuk mencoba terus wahana outbound di Desa Serang.
				</p>
			</div>
			<div class="col-md-4">
