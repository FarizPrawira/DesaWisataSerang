	...
	<div class="container fix-content">
		<div class="row">
			...
			<div class="col-md-6">
				...
				Lokasi Agrowisata ini menjadi penghubung antara tempat wisata lainnya, seperti Goa Lawa, Wista Air Wabong, Sanggaruli Park, dan Purbasari Pancuran Mas.</p>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-offset-1 col-md-6">
				...
				jadi ayo kita sekali-kali untuk merefresh diri kita dengan uniknya  berwisata di agrowisata lembah asri Purbalingga.</p>
			</div>
			<div class="col-md-4">
