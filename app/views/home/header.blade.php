	...
	<div class="menu-list" id="listserang">
		<div class="col-md-8">
			<a href="{{URL::to('serang/pertanian/2010')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/pertanian.jpg')}}">
				<span>
					<h4>Pertanian</h4>
			...
			<a href="{{URL::to('serang/peternakan/2010')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/peternakan.jpg')}}">
				<span>
					<h4>Peternakan</h4>
			...
			<a href="{{URL::to('serang/pemerintahan')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/pemerintahan.jpg')}}">
				<span>
					<h4>Pemerintahan</h4>
			...
			<a href="{{URL::to('serang/kkn-ugm2015')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/kkn.jpg')}}">
				<span>
					<h4>KKN-PPM</h4>
					<p>UGM & IU</p>
				</span>
			...
			<a href="{{URL::to('serang/produk')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/produk.jpg')}}">
				<span>
					<h4>Produk</h4>
		...
		<div class="col-md-4">
			<a href="{{URL::to('serang/galery')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/galery.jpg')}}">
				<span>
					<h4>Galery</h4>
					<p>Gambar & Video</p>
				</span>
			...
			<a href="{{URL::to('serang/map')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/map.jpg')}}">
				<span>
					<h4>Peta</h4>
	...
	<div class="menu-list" id="listwisata">
		<div class="col-md-8">
			<a href="{{URL::to('wisata/stroberi')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/kebunstrawberry.jpg')}}">
				<span>
			...
			<a href="{{URL::to('wisata/restarea')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/restarea.jpg')}}">
				<span>
					<h4>Rest Area</h4>
			...
			<a href="{{URL::to('wisata/outbound')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/outbound.jpg')}}">
				<span>
					<h4>Outbond</h4>
			...
			<a href="{{URL::to('wisata/pinus')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/pinus.jpg')}}">
				<span>
					<h4>Hutan Pinus</h4>
			...
			<a href="{{URL::to('wisata/kuda')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/kuda.jpg')}}">
				<span>
					<h4>Kuda Tunggang</h4>
		...
		<div class="col-md-4">
			<a href="{{URL::to('wisata/tic')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/tic.jpg')}}">
				<span>
					<h4>TIC</h4>
			...
			<a href="{{URL::to('wisata/homestay')}}" class="menu-item">
				<img src="{{URL::to('assets/img/header/homestay.jpg')}}">
				<span>
					<h4>Home Stay</h4>
